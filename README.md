...
En el código que sigue tengo un botón y un canvas. El presionar el botón, se ejecuta una función (pinta). Esta función pinta, en el canvas de identidad "este", un cuadrilátero lleno, de tamaño 100 x 100 pixeles, ubicado a 25 pixeles del extremo izquierdo del lienzo y 25 pixeles de su extremo superior.
